---
name: speech-to-text
description: "Transcribe audio files using 0G Compute Network providers running Whisper Large V3. Supports multiple audio formats and output types (JSON, text, SRT subtitles)."
license: MIT
metadata:
  upstream: "https://github.com/0gfoundation/0g-agent-skills"
  source_path: ".0g-skills/skills/compute/speech-to-text/SKILL.md"
---
