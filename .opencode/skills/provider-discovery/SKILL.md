...
description: "Discover, filter, and verify compute providers on the 0G network. List available services by type (chatbot, text-to-image, speech-to-text), check TEE verification status, and acknowledge providers before first use."
license: MIT
metadata:
  upstream: "https://github.com/0gfoundation/0g-agent-skills"
  source_path: ".0g-skills/skills/compute/provider-discovery/SKILL.md"
---
