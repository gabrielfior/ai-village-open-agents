---
name: text-to-image
description: "Generate images from text prompts using 0G Compute Network providers running Flux Turbo. Supports multiple resolutions and batch generation."
license: MIT
metadata:
  upstream: "https://github.com/0gfoundation/0g-agent-skills"
  source_path: ".0g-skills/skills/compute/text-to-image/SKILL.md"
---
