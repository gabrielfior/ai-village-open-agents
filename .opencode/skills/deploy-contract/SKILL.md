...
description: "Deploy Solidity smart contracts to 0G Chain using Hardhat, Foundry, or ethers v6 directly. All contracts must be compiled with `evmVersion: \"cancun\"`."
license: MIT
metadata:
  upstream: "https://github.com/0gfoundation/0g-agent-skills"
  source_path: ".0g-skills/skills/chain/deploy-contract/SKILL.md"
---
