...
description: "Compute root hashes and verify data integrity for files stored on 0G Storage. Uses Merkle tree proofs to cryptographically verify that downloaded data matches what was originally uploaded."
license: MIT
metadata:
  upstream: "https://github.com/0gfoundation/0g-agent-skills"
  source_path: ".0g-skills/skills/storage/merkle-verification/SKILL.md"
---
