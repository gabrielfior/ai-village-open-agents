...
description: "Initialize a new 0G dApp project with the correct SDK versions, TypeScript configuration, environment setup, and boilerplate code for storage, compute, and/or chain interactions."
license: MIT
metadata:
  upstream: "https://github.com/0gfoundation/0g-agent-skills"
  source_path: ".0g-skills/skills/chain/scaffold-project/SKILL.md"
---
